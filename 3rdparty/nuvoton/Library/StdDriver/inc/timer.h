 ...
 * @brief    Nano102/112 series TIMER driver header file
 *
 * @note
...
/** @addtogroup NANO1X2_TIMER_EXPORTED_CONSTANTS TIMER Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO1X2_TIMER_EXPORTED_CONSTANTS */
