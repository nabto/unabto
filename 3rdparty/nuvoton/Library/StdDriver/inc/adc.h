 ...
 * @brief    Nano102/112 series ADC driver header file
 *
 * @note
...
/** @addtogroup NANO1X2_ADC_Driver ADC Driver
  @{
*/

/** @addtogroup NANO1X2_ADC_EXPORTED_CONSTANTS ADC Exported Constants
  @{
*/
...
#define ADC_ADCHER_CHEN_Msk              (0x3FFFF)                   /*!< ADC channel 0 ~ 17 mask */
...
#define ADC_TRIGGER_BY_PWM               (ADC_CR_TRGS_Msk)           /*!< ADC trigger by PWM events */
...
/*@}*/ /* end of group NANO1X2_ADC_EXPORTED_CONSTANTS */


/** @addtogroup NANO1X2_ADC_EXPORTED_FUNCTIONS ADC Exported Functions
  @{
*/
...
/**
  ...
  * \hideinitializer
  */
#define ADC_IS_DATA_OVERRUN(adc, u32ChNum) (( *(__IO uint32_t *)( &ADC->RESULT0 + (1*u32ChNum)) )& ADC_RESULT_OVERRUN_Msk ? 1 : 0)
...
/**
  ...
  * \hideinitializer
  */
#define ADC_IS_DATA_VALID(adc, u32ChNum) (( *(__IO uint32_t *)( &ADC->RESULT0 + (1*u32ChNum))) & ADC_RESULT_VALID_Msk ? 1 : 0)
...
/**
  ...
  * \hideinitializer
  */
#define ADC_SET_INPUT_CHANNEL(adc, u32Mask) (ADC->CHER = (ADC->CHER & ~ADC_ADCHER_CHEN_Msk) | (u32Mask))
...
/*@}*/ /* end of group NANO1X2_ADC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NANO1X2_ADC_Driver */
