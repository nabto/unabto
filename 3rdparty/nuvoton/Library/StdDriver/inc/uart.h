 ...
 * $Revision: 13 $
 * $Date: 14/12/17 7:05p $
 * @brief    Nano102/112 Series UART control header file.
 *
 * @note
...
/** @addtogroup NANO1X2_UART_Driver UART Driver
  @{
*/

/** @addtogroup NANO1X2_UART_EXPORTED_CONSTANTS UART Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO1X2_UART_EXPORTED_CONSTANTS */


/** @addtogroup NANO1X2_UART_EXPORTED_FUNCTIONS UART Exported Functions
  @{
*/
 ...
 *    @return    TE_Flag.
 */
#define UART_IS_TX_EMPTY(uart)    ((uart->FSR & UART_FSR_TX_EMPTY_F_Msk) >> UART_FSR_TX_EMPTY_F_Pos)
 ...
 *                            - \ref UART_ISR_ABAUD_IS_Msk       : Auto baud-rate interrupt flag
...
/*@}*/ /* end of group NANO1X2_UART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NANO1X2_UART_Driver */
