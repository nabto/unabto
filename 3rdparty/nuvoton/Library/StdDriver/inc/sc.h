 ...
 * @brief    Nano102/112 series Smartcard (SC) driver header file
 *
 * @note
...
/** @addtogroup NANO1X2_SC_Driver SC Driver
  @{
*/

/** @addtogroup NANO1X2_SC_EXPORTED_CONSTANTS SC Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO1X2_SC_EXPORTED_CONSTANTS */


/** @addtogroup NANO1X2_SC_EXPORTED_FUNCTIONS SC Exported Functions
  @{
*/
...
/*@}*/ /* end of group NANO1X2_SC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NANO1X2_SC_Driver */
