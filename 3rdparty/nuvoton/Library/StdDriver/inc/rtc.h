 ...
 * @version  V1.00
 * $Revision: 14 $
 * $Date: 14/11/28 11:26a $
 * @brief    Nano102/112 series RTC driver header file
 *
 * @note
...
/** @addtogroup NANO1X2_RTC_Driver RTC Driver
  @{
*/


/** @addtogroup NANO1X2_RTC_EXPORTED_CONSTANTS RTC Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO1X2_RTC_EXPORTED_CONSTANTS */


/** @addtogroup NANO1X2_RTC_EXPORTED_STRUCTS RTC Exported Structs
  @{
*/
...
/*@}*/ /* end of group NANO1X2_RTC_EXPORTED_STRUCTS */


/** @addtogroup NANO1X2_RTC_EXPORTED_FUNCTIONS RTC Exported Functions
  @{
*/
 ...
 *
 */
#define RTC_GET_TAMPER_FLAG()    ( (RTC->RIIR & RTC_RIIR_SNOOPIS_Msk) >> RTC_RIIR_SNOOPIS_Pos)
...
/*@}*/ /* end of group NANO1X2_RTC_EXPORTED_FUNCTIONS */


/*@}*/ /* end of group NANO1X2_RTC_Driver */
