 ...
 * @brief    Nano102/112 series Smartcard UART mode (SCUART) driver header file
 *
 * @note
...
/** @addtogroup NANO1X2_SCUART_EXPORTED_CONSTANTS SCUART Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO1X2_SCUART_EXPORTED_CONSTANTS */
