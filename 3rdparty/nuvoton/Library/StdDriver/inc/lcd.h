...
/** @addtogroup NANO1X2_LCD_Driver LCD Driver
  @{
*/


/** @addtogroup NANO1X2_LCD_EXPORTED_CONSTANTS LCD Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO1X2_LCD_EXPORTED_CONSTANTS */


/** @addtogroup NANO1X2_LCD_EXPORTED_STRUCTS LCD Exported Structs
  @{
*/
typedef enum {
...
/*@}*/ /* end of group NANO1X2_LCD_EXPORTED_STRUCTS */


/** @addtogroup NANO1X2_LCD_EXPORTED_FUNCTIONS LCD Exported Functions
  @{
*/
...
/*@}*/ /* end of group NANO1X2_LCD_EXPORTED_FUNCTIONS */


/*@}*/ /* end of group NANO1X2_LCD_Driver */
