 ...
 * $Revision: 8 $
 * $Date: 14/11/27 7:57p $
 * @brief    Nano102/112 series CRC driver header file
 *
 * @note
...
/** @addtogroup NANO1X2_CRC_Driver CRC Driver
  @{
*/

/** @addtogroup NANO1X2_CRC_EXPORTED_CONSTANTS CRC Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO1X2_CRC_EXPORTED_CONSTANTS */

/** @addtogroup NANO1X2_CRC_EXPORTED_FUNCTIONS CRC Exported Functions
  @{
*/
 ...
 */
#define CRC_SET_SEED(u32Seed)   { PDMACRC->SEED = (u32Seed); PDMACRC->CTL |= CRC_CTL_CRC_RST_Msk; }
...
/*@}*/ /* end of group NANO1X2_CRC_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NANO1X2_CRC_Driver */
