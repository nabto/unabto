 ...
 * @brief    Nano102/112 series WDT driver header file
 *
 * @note
...
/** @addtogroup NANO1X2_WDT_EXPORTED_CONSTANTS WDT Exported Constants
  @{
*/
...
/*@}*/ /* end of group NANO1X2_WDT_EXPORTED_CONSTANTS */
