 ...
 *                              \ref PDMA_TMR0_TX, \ref PDMA_TMR1_TX, \ref PDMA_TMR2_TX, \ref PDMA_TMR3_TX,
 *                              \ref PDMA_SPI0_RX, \ref PDMA_SPI1_RX, \ref PDMA_UART0_RX, \ref PDMA_UART1_RX,
 *                              \ref PDMA_ADC, \ref PDMA_PWM0_CH0, \ref PDMA_PWM0_CH2, \ref PDMA_MEM
