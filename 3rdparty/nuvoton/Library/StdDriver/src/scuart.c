 ...
 * @brief    Nano 102/112 series Smartcard UART mode (SCUART) driver source file
 *
 * @note
...
/** @addtogroup NANO1X2_SCUART_Driver SCUART Driver
  @{
*/


/** @addtogroup NANO1X2_SCUART_EXPORTED_FUNCTIONS SCUART Exported Functions
  @{
*/
...
uint32_t SCUART_Open(SC_T* sc, uint32_t u32baudrate)
{
    ...
    if(sc == SC0)
        u32Clk /= ((CLK->CLKDIV0 & CLK_CLKDIV0_SC0_N_Msk) >> CLK_CLKDIV0_SC0_N_Pos);
    else
        u32Clk /= (CLK->CLKDIV1 & CLK_CLKDIV1_SC1_N_Msk);
...
/*@}*/ /* end of group NANO1X2_SCUART_EXPORTED_FUNCTIONS */

/*@}*/ /* end of group NANO1X2_SCUART_Driver */
