//;*****************************************************
//;Company :   rakwireless
//;File Name : rak_write_userConfig.c
//;Author :    Junhua
...
/*=============================================================================*/
/**
 * @fn           int16 rak_write_userConfig(void)
 * @brief        UART, rak_write_userConfig
 * @param[in]    none 
 * @param[out]   none
 * @return       errCode
 *               -1 = Module s busy 
...
int8 rak_write_userConfig(void)
{
	...
	SendHeadLen=sprintf((char *)uCmdRspFrame.uCmdRspBuf,"%s%s%s",RAK_WRITE_UCONFIG_CMD,rak_sendLenth,RAK_COMMA);
