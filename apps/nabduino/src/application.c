...
application_event_result application_event(application_request* request, unabto_query_request* readBuffer, unabto_query_response* writeBuffer)
{
  ...
  switch(request->queryId)
  {
    ...
    case QUERY_GET_SYSTEM_INFORMATION:
    {
      ...
      if(!unabto_query_write_uint16(writeBuffer, INFORMATION_FIRMWARE_VERSION) || !unabto_query_write_uint32(writeBuffer, VERSION_MAJOR) || !unabto_query_write_uint32(writeBuffer, VERSION_MINOR))
      {
        return AER_REQ_RSP_TOO_LARGE;
      }
