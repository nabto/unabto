...
#define NP_PAYLOAD_STATS_TYPE_UNABTO_CONNECTION_ESTABLISHED   1
#define NP_PAYLOAD_STATS_TYPE_UNABTO_CONNECTION_FAILED        2
#define NP_PAYLOAD_STATS_TYPE_UNABTO_CONNECTION_ENDED         3
#define NP_PAYLOAD_STATS_TYPE_CLIENT_CONNECTION_ESTABLISHED   4
