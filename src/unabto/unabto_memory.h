...
#define NABTO_MEMORY_STREAM_SEND_SEGMENT_POOL_SIZE nmc.nabtoMainSetup.streamSendSegmentPoolSize
...
#define NABTO_MEMORY_STREAM_SEND_SEGMENT_POOL_SIZE NABTO_STREAM_SEND_SEGMENT_POOL_SIZE
