...
#define FP_ACL_FILE_PUSH_TOKEN_LENGTH 256
...
#if FP_ACL_PUSH_TOKEN_MAX_LENGTH != FP_ACL_FILE_PUSH_TOKEN_LENGTH
#error incompatible push token length with current acl file format
#endif
