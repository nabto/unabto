...
struct goptx_tupple{ int k; int f; const char *s;  zz *l; };
typedef struct goptx_tupple goptx_tupple_t;
#define gopt_start(...)  (const void*)( const goptx_tupple*){ __VA_ARGS__, {0}}
#define gopt_option(k,f,s,l)    goptx_tupple{ k, f, s, l }
